...
<html lang="pt-br" ng-app="CEUACA || Casa do Estudante Universitário Aparício Cora de Almeida">
	...
	<body>
		...
		<div style="background-color:#87CEEB;" class="navbar  navbar-static-top">
			<div class="container">
				<a href="../membro.php" class="navbar-brand">..:: CEUACA</a>
		...
		<div class="container">
			...
			<div class="jumbotron">
				...
				<a href="../membro.php" class="btn btn-default">Inicio</a>
				<a href="#contact" data-toggle="modal" class="btn btn-info">Escrever menssagem</a> </center>
			</div>
					...
					<form class="form-horizontal">
						...
						<div class=" modal-header">
							...
							<div class="modal-body">
								...
								<div class="form-group ">
									<label for="contact-msg" class="col-lg-2 control-label">Para</label>
									<div class="col-lg-10">
										<select class="form-control" name="category">
											<option>sua opção</option>
											<option>Diretória</option>
											<option>Con. Deliberativo</option>
								...
								<div class="form-group">
									<label for="contact-msg" class="col-lg-2 control-label">Menssagem:</label>
									<div class="col-lg-10">
