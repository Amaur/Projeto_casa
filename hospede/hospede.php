	...
	<body>
		...
		<div class="container">
			...
			<div class="jumbotron">
				...
				<a href="#contact" data-toggle="modal" class="btn btn-info">Acessar Formulário</a> </center>
			</div>
					...
					<form class="form-horizontal">
						...
						<div class=" modal-header">
							...
							<div class="modal-body">
								...
								<div class="form-group">
									<label for="contact-sujet" class="col-lg-2 control-label" >Tempo:</label>
									<div class="col-lg-10">
										<input type="text" class="form-control" id="contact-sujet" placeholder="tempo que pretende ficar.." required/>
									</div>
								</div>	
									
									
								<div class="form-group">
									<label for="contact-msg" class="col-lg-2 control-label">Motivo:</label>
									<div class="col-lg-10">
										<textarea class="form-control" rows="5" placeholder="Porque neccessita de hospedagem ?" required maxLength="200" data-minlength="10"></textarea>
									</div>
								</div>
